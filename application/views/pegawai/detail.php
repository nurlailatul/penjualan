        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php if ($updateAct || $updateActOwn){ ?>
                    <a href="<?php echo site_url('pegawai/create_edit/'.$detail->id_pegawai); ?>"> <button type="button" class="btn btn-info mr-10"><i class="fa fa-pencil-square-o"></i> Edit</button></a>
                <?php } ?>
