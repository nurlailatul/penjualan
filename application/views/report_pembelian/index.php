            ...
            <div class="box box-default">
                <div class="box-body">
                    <div class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <?php endif; ?>
                        <form method="get" class="form-inline form-filter" action="<?php echo site_url('report_pembelian/index'); ?>">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mt-5">
                                                ...
                                                <select class="form-control" name="groupby">
                                                    ...
                                                    <option value="supplier" <?php echo isset($groupby) && $groupby == 'supplier' ? 'selected' : ''; ?>>Supplier</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo site_url("report_pembelian/index") ?>" class="btn btn-danger mt-5" <?php echo isset($is_filter) ? '' : 'disabled'; ?>><span class="fa fa-refresh"></span> Reset</a>
                                    </div>
							...
							<table class="table table-bordered table-hover table-responsive">
                                ...
                                foreach ($data as $r){
                                    ...
                                    <?php if(isset($groupby)){
                                        if($groupby == 'supplier') {
                                            if($last_supplier != '' && $last_supplier != $r->id_supplier){ ?>

                                                <tr>
                                                    <td colspan="4" align="center" class="text-bold">JUMLAH</td>
                                                    <td class="wrap text-right text-bold">Rp. <?php echo set_currency_format($groupPembelian); ?></td>
                                                </tr>

                                            <?php
                                                $groupPembelian = 0;
                                            }
                                            $last_supplier = $r->id_supplier;
                                        }
                                        if($groupby == 'tanggal') {
                                    ...
                                    <tr>
                                        ...
                                        <td class="wrap">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-success" href="<?php echo site_url('trans_pembelian/index?periode='.$tgl.'+-+'.$tgl.'&supplier[]='.$r->id_supplier); ?>"><i class="fa fa-search"></i>  </a>
                                            </div>
                                        </td>
                                        <td class="wrap"><?php echo $r->nama; ?></td>
                                        <td class=""><?php echo set_indo_date($r->tgl); ?></td>
                                        <td class="wrap text-right">Rp. <?php echo set_currency_format($r->tot_pembelian); ?></td>
                                    </tr>
                                    <?php
                                    $sumPembelian += $r->tot_pembelian;

                                    if(isset($groupby)) {
                                        $groupPembelian += $r->tot_pembelian;
                                    }
                                    ?>
                                <?php } ?>
                                ...
                                <tr class="bg-gray">
                                    ...
                                    <td class="wrap text-right text-bold">Rp. <?php echo set_currency_format($sumPembelian); ?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
