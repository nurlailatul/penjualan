            ...
            <div class="box box-default">
                <div class="box-body">
                    <div class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <?php endif; ?>
                        <form method="get" class="form-inline form-filter" action="<?php echo site_url('report_penjualan/by_hari_reseller'); ?>">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mt-5">
                                                ...
                                                <select class="form-control" name="groupby">
                                                    ...
                                                    <option value="reseller" <?php echo isset($groupby) && $groupby == 'reseller' ? 'selected' : ''; ?>>Pelanggan</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo site_url("report_penjualan/by_hari_reseller") ?>" class="btn btn-danger mt-5" <?php echo isset($is_filter) ? '' : 'disabled'; ?>><span class="fa fa-refresh"></span> Reset</a>
                                    </div>
                            ...
                            <table class="table table-bordered table-hover table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wrap">Tanggal Transaksi</th>
                                ...
                                foreach ($data as $r){
                                    ...
                                    <?php if(isset($groupby)){
                                        if($groupby == 'reseller') {
                                            if($last_reseller != '' && $last_reseller != $r->id_pelanggan){ ?>

                                                <tr>
                                                    <td colspan="4" align="center" class="text-bold">JUMLAH</td>
                                                    <td class="wrap text-right text-bold">Rp. <?php echo set_currency_format($groupLaba); ?></td>
                                                    <td class="wrap text-right text-bold">Rp. <?php echo set_currency_format($groupPenjualan); ?></td>
                                                </tr>

                                            <?php
                                                $groupLaba = $groupPenjualan= 0;
                                            }
                                            $last_reseller = $r->id_pelanggan;
                                        }
                                        if($groupby == 'tanggal') {
                                    ...
                                    <tr>
                                        ...
                                        <td class="wrap">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-success" href="<?php echo site_url('trans_penjualan/index?periode='.$tgl.'+-+'.$tgl.'&reseller[]='.$r->id_pelanggan); ?>"><i class="fa fa-search"></i>  </a>
                                            </div>
                                        </td>
                                        <td class=""><?php echo $r->nama; ?></td>
                                        <td class="wrap"><?php echo set_indo_date($r->tgl); ?></td>
                                    ...
                                    if(isset($groupby)) {
                                        $groupLaba += $r->tot_laba;
                                        $groupPenjualan += $r->tot_penjualan;
                                    }
                                    ?>
                                <?php } ?>
