            ...
            <div class="box box-default">
                <div class="box-body">
                    <div class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <?php endif; ?>
                        <form method="get" class="form-inline form-filter" action="<?php echo site_url('report_penjualan/by_pelanggan'); ?>">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo site_url("report_penjualan/by_pelanggan") ?>" class="btn btn-danger mt-5" <?php echo isset($is_filter) ? '' : 'disabled'; ?>><span class="fa fa-refresh"></span> Reset</a>
                                    </div>
                            ...
                            <table class="table table-bordered table-hover table-responsive">
                                ...
                                foreach ($data as $r){
                                    ...
                                    <tr>
                                        ...
                                        <td class="wrap">
                                            <div class="btn-group">
                                                <a class="btn btn-success" href="<?php echo site_url('trans_penjualan/index?pelanggan[]='.$r->id_pelanggan); ?>"><i class="fa fa-search"></i>  </a>
                                            </div>
                                        </td>
