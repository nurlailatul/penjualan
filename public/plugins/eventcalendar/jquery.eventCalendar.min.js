...
$.fn.eventCalendar=function(options){
	...
	this.each(function(){
		...
		flags.wrap.on("click",".eventsCalendar-day a",function(e){
			e.preventDefault();
			var year=flags.wrap.attr("data-current-year"),month=flags.wrap.attr("data-current-month"),day=$(this).parent().attr("rel");
	...
	function getEvents(limit,year,month,day,direction){
		...
		if(day>""){
			flags.wrap.find(".current").removeClass("current");flags.wrap.find("#dayList_"+day).addClass("current")
		}
	}
	
	
	function getEventsData(data,limit,year,month,day,direction){
		directionLeftMove="-="+flags.directionLeftMove;eventContentHeight="auto";
		...
		flags.wrap.find(".eventsCalendar-list").animate({opacity:eventsOpts.moveOpacity,left:directionLeftMove,height:eventContentHeight},eventsOpts.moveSpeed,function(){
					...
					if(limit===0||limit>i){
						if((month===false||month==eventMonth)&&(day==""||day==eventDay)&&(year==""||year==eventYear)){
							if(month===false&&eventDate<new Date()){
								...
								if(event.title == "Karyawan Izin"){
									pluss = "<br><br><br><div class=\"row\"><div class=\"col-md-12\"><div class=\"col-md-12\"><a onclick=\"addKaryawan('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-warning btn-lg btn-block\"><span class=\"fa fa-plus\"></span> Tambahkan Karyawan Lain yang Izin pada tanggal ini</a></div></div></div><br>";
								}else if(event.title == "Agenda Karyawan"){
									pluss = "<br><br><br><div class=\"row\"><div class=\"col-md-12\"><div class=\"col-md-6\"><a onclick=\"addKaryawan('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-warning btn-lg btn-block\"><span class=\"fa fa-plus\"></span> Tambahkan Karyawan Lain  yang Izin tanggal ini</a></div></div></div><br>";
								}else if(event.title != "Hari Libur" && i == 0){
									pluss = "<br><br><br><div class=\"row\"><div class=\"col-md-12\"><div class=\"col-md-6\"><a onclick=\"addKaryawan('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-warning btn-lg btn-block\"><span class=\"fa fa-plus\"></span> Input Karyawan Izin</a></div><div class=\"col-md-6\"><a onclick=\"batalHoliday('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-danger btn-lg btn-block\"><span class=\"fa fa-times\"></span> Batalkan Hari Libur</a></div></div></div><br>";
								}else if(event.title == "Hari Libur" ){
									pluss = "<br><br><br><div class=\"row\"><div class=\"col-md-12\"><div class=\"col-md-6\"><a onclick=\"addKaryawan('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-warning btn-lg btn-block\"><span class=\"fa fa-plus\"></span> Input Karyawan Izin</a></div><div class=\"col-md-6\"><a onclick=\"batalHoliday('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-danger btn-lg btn-block\"><span class=\"fa fa-times\"></span> Batalkan Hari Libur</a></div></div></div><br>";
								}
			...
			if(!events.length && flags.wrap.find(".current")[0]){
				events.push('<li class="eventsCalendar-noEvents"><p>'+eventsOpts.txt_noEvents+"<div class=\"row\"><div class=\"col-md-12\"><div class=\"col-md-6\"><a onclick=\"addHoliday('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-success btn-lg btn-block\"><span class=\"fa fa-flag\"></span> Input Hari Libur Pada Tanggal ini</a></div><div class=\"col-md-6\"><a onclick=\"addKaryawan('"+day+"','"+(parseInt(month)+1)+"','"+year+"')\" class=\"btn btn-warning btn-lg btn-block\"><span class=\"fa fa-plus\"></span> Input Karyawan Izin</a></div></div></div><br><br></p></li>")
			}else{
				events.push(pluss)
			}
